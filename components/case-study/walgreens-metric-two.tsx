...
export function WalgreensMetricTwo({ width = 84, height = 72 }: WalgreensMetricTwoProps) {
    ...
    >
      ...
      <g
        style={{
          ...
          transition: transitionOrNone(`opacity 360ms ${ease} 80ms, transform 360ms ${ease} 80ms`),
      ...
      <g
        style={{
          ...
          transition: transitionOrNone(`opacity 320ms ${ease} 520ms, transform 320ms ${ease} 520ms`),
          willChange: "opacity, transform",
        }}
      >
      ...
      <g
        style={{
          ...
          transition: transitionOrNone(`opacity 360ms ${ease} 660ms, transform 360ms ${ease} 660ms`),
          willChange: "opacity, transform",
        }}
      >
